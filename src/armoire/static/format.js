...
// Every write to location.hash must go through this. A raw "%" or other
// reserved character in a path segment is not a valid percent-escape, and
// currentRoute()'s decodeURIComponent throws on it.
